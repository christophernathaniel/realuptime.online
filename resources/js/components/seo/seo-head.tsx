...
function serializeStructuredData(value: SeoStructuredData): string {
...
export function SeoHead({
    ...
    const resolvedDescription =
        description ??
        'RealUptime helps teams monitor websites, services, incidents, and public status communication from one operational workspace.';
