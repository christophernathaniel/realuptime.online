...
function StatusPageIncidentCard({ incident }: { incident: StatusPageIncidentItem }) {
    ...
    return (
        <div className="space-y-4 rounded-[18px] border border-white/8 bg-[#111a2c] px-5 py-5">
            ...
            <div className="space-y-3">
                {incident.updates.map((update) => (
                    <div key={update.id} className="rounded-[14px] bg-[#0d1628] px-4 py-4">
            ...
            <form
                className="grid gap-4 rounded-[16px] border border-white/6 bg-[#0d1628] px-4 py-4"
                onSubmit={(event) => {
                ...
                <div className="grid gap-4 lg:grid-cols-[220px_minmax(0,1fr)]">
                    <label className="space-y-2">
                        ...
                        <select
                            ...
                            className="h-11 w-full rounded-[14px] border border-white/10 bg-[#091426] px-4 text-sm text-white outline-none"
                        >
                            {incidentStatuses.map((status) => (
                                <option key={status.value} value={status.value} className="bg-[#091426]">
                                    {status.label}
                                </option>
                            ))}
                        </select>
                    ...
                    <label className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="min-h-[88px] w-full rounded-[14px] border border-white/10 bg-[#091426] px-4 py-3 text-sm text-white outline-none"
    ...
    return (
        <PageCard className="space-y-6 p-6">
            ...
            <div className="space-y-4 border-t border-white/8 pt-6">
                ...
                <form
                    className="grid gap-4 rounded-[18px] border border-white/6 bg-[#0d1628] px-4 py-4"
                            ...
                            <label className="space-y-2">
                                ...
                                >
                                    {incidentImpacts.map((impact) => (
                                        <option key={impact.value} value={impact.value} className="bg-[#091426]">
                                            {impact.label}
                                        </option>
                                    ))}
                                </select>
                ...
                <div className="space-y-4">
                    {page.incidents.length === 0 ? (
                        <div className="rounded-[16px] border border-dashed border-white/10 bg-[#111a2c] px-4 py-5 text-[14px] text-[#8fa0bf]">
            ...
            <div className="space-y-5">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        <h1 className="text-[40px] font-semibold tracking-[-0.06em] text-white lg:text-[46px]">
                            Status pages<span className="text-[#3ee072]">.</span>
                        </h1>
                        <div className="mt-2 max-w-[760px] text-[16px] text-[#8fa0bf]">
                            Publish public-facing status dashboards for any subset of monitors. Each page gets its own shareable URL and its own incident communications feed.
                        </div>
                    </div>
                    <div className="grid gap-3 sm:grid-cols-4">
                        <PageCard className="px-5 py-4">
                            <div className="text-sm text-[#8fa0bf]">Published</div>
                            <div className="mt-1 text-[30px] font-semibold text-white">{summary.published}</div>
                        </PageCard>
                        <PageCard className="px-5 py-4">
                            <div className="text-sm text-[#8fa0bf]">Drafts</div>
                            <div className="mt-1 text-[30px] font-semibold text-white">{summary.drafts}</div>
                        </PageCard>
                        <PageCard className="px-5 py-4">
                            <div className="text-sm text-[#8fa0bf]">Monitors exposed</div>
                            <div className="mt-1 text-[30px] font-semibold text-white">{summary.monitors}</div>
                        </PageCard>
                        <PageCard className="px-5 py-4">
                            <div className="text-sm text-[#8fa0bf]">Active posts</div>
                ...
                <PageCard className="space-y-5 p-6">
                    <div className="flex items-center gap-3 text-[22px] font-semibold text-white">
                        <Globe2 className="size-5 text-[#3ee072]" />
                        Create status page
                    </div>
                    <form
                        className="grid gap-4"
