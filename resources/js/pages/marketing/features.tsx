            ...
            <section className="mx-auto max-w-[1380px] px-6 py-16 lg:px-10 lg:py-22">
                <div className="max-w-[920px]">
                    ...
                    <h1 className="mt-5 text-[40px] font-semibold leading-[0.9] tracking-[-0.08em] text-white sm:text-[50px] lg:text-[62px]">
                        Monitoring, alerting, incidents, and public communication from one product<span className="text-[#7c8cff]">.</span>
                    </h1>
                ...
                <div className="mt-12 grid gap-5 lg:grid-cols-2 xl:grid-cols-3">
                    {marketingFeatures.map((feature) => (
                        <Link
                            ...
                            className="group rounded-[30px] border border-white/8 bg-[linear-gradient(180deg,#0a1730_0%,#071121_100%)] p-7 transition hover:-translate-y-1 hover:border-[#7c8cff]/35"
                        >
                            <span className="inline-flex size-14 items-center justify-center rounded-[20px] border border-[#18325a] bg-[#091223] text-[#7c8cff]">
                            ...
                            <div className="mt-6 inline-flex items-center gap-2 text-[16px] font-medium text-[#7c8cff]">
                                Explore feature
