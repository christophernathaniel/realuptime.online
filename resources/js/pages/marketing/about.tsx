            ...
            <section className="mx-auto max-w-[1380px] px-6 py-16 lg:px-10 lg:py-22">
                <div className="max-w-[980px]">
                    ...
                    <h1 className="mt-5 text-[40px] font-semibold leading-[0.9] tracking-[-0.08em] text-white sm:text-[52px] lg:text-[66px]">
                        Built for teams that need the signal fast and the context immediately after<span className="text-[#42df79]">.</span>
                    </h1>
                ...
                <div className="mt-12 grid gap-5 lg:grid-cols-3">
                    {[
                        ...
                        },
                        {
                            ...
                            copy: 'The product focuses on the monitor types and workflows teams actually use in production: websites, APIs, ping, SSL, heartbeats, and incidents.',
                        },
                        {
                            title: 'Room to scale',
                ...
                <div className="mt-12 rounded-[34px] border border-white/8 bg-[linear-gradient(120deg,#0a1730_0%,#07111f_100%)] p-8 lg:p-10">
                    <div className="grid gap-6 lg:grid-cols-3">
                        {[
                            ['Detect', 'Monitor websites, endpoints, ping targets, heartbeats, and certificates from one workspace.'],
                            ...
                            <div key={title}>
                                ...
                                <div className="mt-3 text-[24px] font-semibold tracking-[-0.05em] text-white">{title} with intent<span className="text-[#42df79]">.</span></div>
                ...
                <div className="mt-12 flex flex-wrap gap-4">
                    <Link href="/pricing" className="inline-flex h-14 items-center justify-center rounded-full bg-[#42df79] px-6 text-[17px] font-semibold text-[#082039] transition hover:bg-[#36cb68]">
                        Compare plans
                    </Link>
