...
import { ArrowRight, BellRing, Gauge, Globe2, ShieldCheck } from 'lucide-react';
...
export default function MarketingHome({ canRegister = true }: { canRegister?: boolean }) {
    return (
        <MarketingLayout
            title="RealUptime"
            description="Monitor websites, endpoints, ping targets, SSL certificates, incidents, and public status pages from one operational workspace."
        >
            <section className="mx-auto grid max-w-[1380px] gap-12 px-6 py-14 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-22">
                <div>
                    ...
                    <h1 className="mt-7 max-w-[11ch] text-[42px] font-semibold leading-[0.9] tracking-[-0.08em] text-white sm:text-[52px] lg:text-[66px]">
                        Catch downtime before your users do<span className="text-[#42df79]">.</span>
                    </h1>
                    <p className="mt-6 max-w-[34ch] text-[20px] leading-9 text-[#9eb0cb] sm:text-[22px]">
                        RealUptime brings website monitoring, endpoint checks, SSL tracking, incident management, public status pages, and alerting into one live operational product.
                    </p>
                    <div className="mt-8 flex flex-wrap gap-4">
                        <Link href={canRegister ? '/register' : '/login'} className="inline-flex h-14 items-center justify-center rounded-full bg-[#42df79] px-6 text-[17px] font-semibold text-[#082039] transition hover:bg-[#37cb69]">
                    ...
                    <div className="mt-10 grid gap-4 sm:grid-cols-3">
                        {[
                            ['30 sec', 'Fastest available check interval'],
                            ['Email + webhooks', 'Alerting for operators and tools'],
                            ['Status pages', 'Publish uptime and incidents publicly'],
                        ].map(([value, label]) => (
                ...
                <div className="grid gap-4 lg:pt-10">
                    <div className="rounded-[34px] border border-white/8 bg-[#0a1730] p-6 shadow-[0_30px_90px_rgba(0,0,0,0.3)]">
                        <div className="flex items-center justify-between gap-4">
                            <div>
                                <div className="text-[14px] font-semibold uppercase tracking-[0.22em] text-[#7083a2]">Live overview</div>
                                <div className="mt-2 text-[28px] font-semibold tracking-[-0.05em] text-white">Production API<span className="text-[#42df79]">.</span></div>
                            </div>
                            <div className="rounded-full bg-[#12361f] px-4 py-2 text-[13px] font-semibold uppercase tracking-[0.2em] text-[#42df79]">Operational</div>
                        </div>
                        <div className="mt-8 grid gap-4 sm:grid-cols-3">
                            <div className="rounded-[22px] bg-[#0f1d38] px-5 py-5">
                                <div className="text-[15px] text-[#8ea0bf]">Current status</div>
                                <div className="mt-3 text-[34px] font-semibold tracking-[-0.06em] text-[#42df79]">Up</div>
                            ...
                            <div className="rounded-[22px] bg-[#0f1d38] px-5 py-5">
                                ...
                                <div className="mt-3 flex gap-1">
                                    {Array.from({ length: 24 }).map((_, index) => (
                                        <span key={index} className="h-9 w-2 rounded-full bg-[#42df79]" />
                                    ))}
                                </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        {[
                            ...
                            {
                                icon: ShieldCheck,
                                title: 'SSL visibility',
                                copy: 'Watch certificate and domain expiry without extra tooling.',
                            },
                            {
                                icon: BellRing,
                            ...
                            <div key={title} className="rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,#0b1831_0%,#091426_100%)] px-5 py-6">
                                <Icon className="size-6 text-[#42df79]" />
            ...
            <section className="mx-auto max-w-[1380px] px-6 py-8 lg:px-10 lg:py-12">
                <div className="grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-end">
                    <div>
                        <div className="text-[14px] font-semibold uppercase tracking-[0.22em] text-[#7083a2]">Features</div>
                        <h2 className="mt-4 text-[28px] font-semibold leading-[0.92] tracking-[-0.07em] text-white sm:text-[36px] lg:text-[46px]">
                            One product for uptime, alerts, incidents, and status pages<span className="text-[#42df79]">.</span>
                        </h2>
                    </div>
                    <p className="max-w-[42ch] text-[18px] leading-8 text-[#95a8c5] sm:text-[20px]">
                        Build the public website, the operational workflow, and the customer communication loop around the same live monitor data.
                    </p>
                </div>
                <div className="mt-10 grid gap-5 lg:grid-cols-3">
                    {marketingFeatures.slice(0, 6).map((feature) => (
                        <Link
                            ...
                            className="group rounded-[30px] border border-white/8 bg-[radial-gradient(circle_at_top,rgba(66,223,121,0.08),transparent_34%),linear-gradient(180deg,#091427_0%,#08111f_100%)] p-6 transition hover:-translate-y-1 hover:border-[#42df79]/30"
                        >
                            <div className="inline-flex size-14 items-center justify-center rounded-[20px] border border-[#17335d] bg-[#091223] text-[#42df79]">
                                <FeatureIcon icon={feature.icon} className="size-6 shrink-0" />
                            </div>
                            <div className="mt-24 text-[28px] font-semibold tracking-[-0.06em] text-white">{feature.shortLabel}</div>
                            <div className="mt-3 text-[17px] leading-8 text-[#8ea0bf]">{feature.menuDescription}</div>
                            <div className="mt-8 inline-flex size-12 items-center justify-center rounded-full border border-white/12 text-[#42df79] transition group-hover:bg-[#42df79] group-hover:text-[#082039]">
                    ...
                    <div className="grid gap-10 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
                        <div>
                            ...
                            <h2 className="mt-4 text-[28px] font-semibold leading-[0.92] tracking-[-0.07em] text-white sm:text-[34px] lg:text-[42px]">
                                Publish uptime, incidents, and maintenance from the same workspace<span className="text-[#42df79]">.</span>
                            </h2>
                            ...
                            <div className="mt-8 space-y-4">
                                {[
                                    ...
                                    <div key={item} className="flex items-center gap-3 text-[18px] text-white">
                                        <span className="inline-flex size-8 items-center justify-center rounded-full bg-[#112b1d] text-[#42df79]">
                            ...
                            <div className="mt-9 flex flex-wrap gap-4">
                                <Link href="/features/public-status-pages" className="inline-flex h-14 items-center justify-center rounded-full border border-[#42df79] px-6 text-[17px] font-medium text-[#42df79] transition hover:bg-[#42df79] hover:text-[#082039]">
                                    Learn more
                                </Link>
                        ...
                        <div className="relative min-h-[360px] rounded-[32px] border border-white/8 bg-[radial-gradient(circle_at_center,rgba(66,223,121,0.08),transparent_35%),linear-gradient(180deg,#0b1730_0%,#081326_100%)] p-6 sm:min-h-[420px]">
                            <div className="absolute right-6 top-6 rotate-[-12deg] rounded-[24px] border border-white/8 bg-[#0e1a31] px-5 py-4 shadow-[0_30px_60px_rgba(0,0,0,0.35)]">
                                ...
                                <div className="mt-3 flex items-center gap-3 rounded-[18px] bg-[#132542] px-4 py-4 text-[18px] font-semibold text-white">
                                    <span className="inline-flex size-4 rounded-full bg-[#42df79]" />
                                    All systems operational
                                </div>
                            </div>
                            <div className="absolute bottom-8 left-6 right-10 rounded-[28px] border border-white/8 bg-[#0f1a30] p-6 shadow-[0_28px_70px_rgba(0,0,0,0.35)]">
                                <div className="flex items-center justify-between gap-4">
                                    <div>
                                    ...
                                    <div className="text-[32px] font-semibold tracking-[-0.06em] text-[#42df79]">100%</div>
                                </div>
                                <div className="mt-5 flex gap-1">
                                    {Array.from({ length: 30 }).map((_, index) => (
                                        <span key={index} className="h-10 w-2 rounded-full bg-[#42df79]" />
                                    ))}
                                </div>
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                        <div>
                            ...
                            <h2 className="mt-4 max-w-[11ch] text-[30px] font-semibold leading-[0.92] tracking-[-0.07em] text-[#16233c] sm:text-[38px] lg:text-[46px]">
                                Honest pricing built around the product that ships<span className="text-[#42df79]">.</span>
                            </h2>
                        </div>
                        <p className="max-w-[42ch] text-[18px] leading-8 text-[#5d6d89]">
                            Start free, unlock full workspace features with Premium, and scale to larger estates with Ultra. No hidden feature bundles, no separate toolchain.
                        </p>
                    </div>
                    <div className="mt-10">
