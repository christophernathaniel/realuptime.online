...
function SidebarContent({
    ...
    return (
        <div className="monitoring-sidebar-inner relative flex h-full flex-col lg:overflow-y-auto">
            <div className="flex items-center justify-between gap-3 px-2 pb-6 pt-1.5">
                ...
                {mobile ? (
                    <button
                        ...
                        className="inline-flex size-10 items-center justify-center rounded-[14px] border border-white/8 bg-white/5 text-[#dce6fb] transition hover:bg-white/10"
    ...
    return (
        <div className="monitoring-shell min-h-screen bg-[#081428] text-[#f4f7ff]">
            <div className="flex min-h-screen flex-col lg:h-screen lg:flex-row">
                <aside className="monitoring-sidebar relative hidden overflow-hidden border-b border-white/5 bg-[linear-gradient(180deg,#0f1d33_0%,#0a182c_56%,#072235_100%)] px-4 py-5 lg:sticky lg:top-0 lg:block lg:h-screen lg:w-[302px] lg:shrink-0 lg:border-b-0 lg:border-r">
                ...
                {mobileNavOpen ? (
                    <div className="fixed inset-0 z-50 lg:hidden">
                        <button
                            type="button"
                            aria-label="Close navigation"
                            className="absolute inset-0 bg-[#020712]/70 backdrop-blur-sm"
                            onClick={() => setMobileNavOpen(false)}
                        />
                        <aside className="monitoring-sidebar absolute inset-y-0 left-0 w-[min(85vw,302px)] overflow-hidden border-r border-white/8 bg-[linear-gradient(180deg,#0f1d33_0%,#0a182c_56%,#072235_100%)] px-4 py-5 shadow-[0_30px_80px_rgba(0,0,0,0.45)]">
                            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_bottom,#0f4f45_0%,transparent_35%),radial-gradient(circle_at_top,#183353_0%,transparent_50%)] opacity-40" />
                            <SidebarContent
                                user={user}
                                pathname={pathname}
                ...
                <main className="relative flex-1 overflow-hidden bg-[radial-gradient(circle_at_top,#0a2040_0%,transparent_40%),linear-gradient(180deg,#071325_0%,#081428_100%)] px-4 py-5 sm:px-5 lg:h-screen lg:overflow-y-auto lg:px-6 lg:py-5">
                    ...
                    <div className="monitoring-page relative mx-auto w-full max-w-[1600px] space-y-3.5">
                        <div className="flex items-center justify-between rounded-[18px] border border-white/8 bg-[#0d1729]/80 px-4 py-3 shadow-[0_18px_40px_rgba(0,0,0,0.18)] lg:hidden">
                            <div className="flex items-center gap-2.5">
                                <span className="inline-flex size-2.5 rounded-full bg-[#3ee072]" />
                                <span className="text-[21px] font-semibold tracking-[-0.04em] text-white">
                                    RealUptime
                                </span>
                            </div>
                            <button
