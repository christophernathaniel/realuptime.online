...
class WebhookWorkspaceIntegrationProvider implements WorkspaceIntegrationProvider
{
    ...
    protected function workflowPayload(WorkspaceIntegration $integration, string $event, array $payload): array
    {
        return [
            ...
            'message_title' => data_get($payload, 'message.title'),
            'message_summary' => data_get($payload, 'message.summary'),
            'message_status_label' => data_get($payload, 'message.status_label'),
            'message_status_tone' => data_get($payload, 'message.status_tone'),
            'message_icon' => data_get($payload, 'message.icon'),
            'message_reason' => data_get($payload, 'message.reason'),
            'message_link_label' => data_get($payload, 'message.link_label'),
